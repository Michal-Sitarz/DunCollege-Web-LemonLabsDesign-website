...
<!-- content -->
		<div id="content">
			...
			<div id="photo-gallery">
				...
				<!-- This Gallery Slider works with jquery library -->
				...
				<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 456px; overflow: hidden; visibility: hidden; background-color: lightgray;">
					<!-- Loading Screen -->
